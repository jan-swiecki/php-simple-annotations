...
require_once 'DocBlockReader.php';

class DocBlockReaderTest extends PHPUnit_Framework_TestCase
{
	public function testParserOne()
	{
		$reader = new Common\DocBlockReader($this, 'parserFixture');
	...
	{
		$reader = new Common\DocBlockReader($this, 'parserEmptyFixture');
		$parameters = $reader->getParameters();
	...
	{
		$reader = new Common\DocBlockReader($this, 'parserMultiFixture');
		$parameters = $reader->getParameters();
	...
	{
		$reader = new Common\DocBlockReader($this, 'fixtureThree');
	...
	{
		$reader = new Common\DocBlockReader($this, 'fixtureFour');
	...
	{
		$reader1 = new Common\DocBlockReader($this, 'fixtureFive');
		$reader2 = new Common\DocBlockReader($this, 'fixtureFive');
	...
	{
		$reader = new Common\DocBlockReader($this, 'fixtureVariableDeclarations');
	...
	{
		$reader = new Common\DocBlockReader($this, $methodName);
		$declarations = $reader->getVariableDeclarations("param");
	}
